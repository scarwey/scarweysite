...
namespace Ecommerce.API.Migrations
{
    ...
    [Migration("20250809211900_AddRefundItemsTable")]
    partial class AddRefundItemsTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECommerce.API.Models.Product", b =>
                {
                    ...
                    b.ToTable("Products", t =>
                        {
                            t.HasCheckConstraint("CK_Product_Gender", "\"Gender\" IS NULL OR \"Gender\" IN ('Erkek', 'Kadın', 'Uniseks', 'Çocuk')");
                        });
                });
            ...
            modelBuilder.Entity("ECommerce.API.Models.ProductVariant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("ProductVariants", t =>
                        {
                            t.HasCheckConstraint("CK_ProductVariant_SortOrder", "\"SortOrder\" >= 0");

                            t.HasCheckConstraint("CK_ProductVariant_StockQuantity", "\"StockQuantity\" >= 0");
                        });
                });

            modelBuilder.Entity("ECommerce.API.Models.RefundItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ECommerce.API.Models.RefundRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ECommerce.API.Models.CartItem", b =>
                {
                    ...
                    b.HasOne("ECommerce.API.Models.ProductVariant", "ProductVariant")
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("ECommerce.API.Models.Order", b =>
                {
                    b.HasOne("ECommerce.API.Models.User", "CancelledBy")
                        .WithMany()
            ...
            modelBuilder.Entity("ECommerce.API.Models.RefundItem", b =>
                {
                    b.HasOne("ECommerce.API.Models.OrderItem", "OrderItem")
                        .WithMany()
                        .HasForeignKey("OrderItemId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ECommerce.API.Models.RefundRequest", "RefundRequest")
            ...
            modelBuilder.Entity("ECommerce.API.Models.RefundRequest", b =>
                {
                    ...
                    b.HasOne("ECommerce.API.Models.User", "ProcessedBy")
                        .WithMany()
                        .HasForeignKey("ProcessedByUserId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("ECommerce.API.Models.User", "RequestedBy")
                        .WithMany()
